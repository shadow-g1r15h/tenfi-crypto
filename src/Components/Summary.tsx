                            ...
                            <div className={`col-lg-${d.lgCol} col-md-6 px-1 py-1`}>
                                <div className="sumamrized-data-container jumbotron d-flex flex-column justify-content-between p-2 mb-0 mx-1">
                                    <h4 className="summarized-data-heading d-flex ">
                                        {d.heading} 
                                        {d.hasClaimAllButton && 
                                            <button className=" ml-auto standard-outline-button" style={{padding: "8px", background: 'transparent'}}>Claim All</button>
                                        }
                                    </h4>
                                    <div className="d-flex">
                                        <h4 className="summarized-data-value white-text">{d.value}</h4>
                                        &ensp;
                                        {d.hasSubValue && <span className="summarized-data-subvalue mt-3">{d.subValue}</span>}
                                    </div>
                                </div>
                            </div>
